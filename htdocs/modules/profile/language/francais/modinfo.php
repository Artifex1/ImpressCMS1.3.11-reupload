...
define("_MI_PROFILE_NUMBPICT_TITLE", "Nombre d'images");
define("_MI_PROFILE_NUMBPICT_DESC", "Nombre d'images qu'un utilisateur peut avoir dans ses albums. '0' pour désactiver la vérification (non recommandé).");

define("_MI_PROFILE_THUMW_TITLE" , "Largeur des vignettes");
define("_MI_PROFILE_THUMBW_DESC" , "Largeur des vignettes en pixels<br />Ceci signifie que les vignettes de vos images<br />auront au maximum cette taille en largeur<br />Toutes les proportions étant maintenues");
define("_MI_PROFILE_THUMBH_TITLE" , "Hauteur des vignettes");
define("_MI_PROFILE_THUMBH_DESC" , "Hauteur des vignettes en pixels<br />Ceci signifie que les vignettes de vos images<br />auront au maximum cette taille en hauteur<br />Toutes les proportions étant maintenues");
...
define("_MI_PROFILE_PICTURESPERPAGE_TITLE", "Images par page");
...
define("_MI_PROFILE_PICTURE_NOTIFYTIT", "Images");
define("_MI_PROFILE_PICTURE_NOTIFYDSC", "Notifications related to user's pictures");
define("_MI_PROFILE_PICTURE_NEWPIC_NOTIFY", "Nouvel image");
...
define("_MI_PROFILE_VIDEO_NOTIFYTIT", "Vidéos");
define("_MI_PROFILE_VIDEO_NOTIFYDSC", "Video notifications");
define("_MI_PROFILE_VIDEO_NEWVIDEO_NOTIFY", "Nouveau Vidéo");
...
define("_MI_PROFILE_TRIBETOPIC_NOTIFYTIT", "Groupes");
...
define("_MI_PROFILE_TRIBEPOST_NOTIFYTIT", "Groupes");
...
define("_MI_PROFILE_MYCONFIGS", "Paramètres");
...
define("_MI_PROFILE_SEARCH", "Recherche membres");
...
define("_MI_PROFILE_BLOCKS_FRIENDS", "Mes amis");
define("_MI_PROFILE_BLOCKS_USERMENU", "Menu utilisateur");
...
define("_MI_PROFILE_NAME", "Profil");
...
define("_MI_PROFILE_CAT_COMMUNITY", "Communauté");
define("_MI_PROFILE_CAT_BASEINFO", "Informations de base");
define("_MI_PROFILE_CAT_EXTINFO", "Informations suplémentaires");
define("_MI_PROFILE_CAT_SETTINGS", "Paramètres généraux");
define("_MI_PROFILE_CAT_SETTINGS_DSC", "");
define("_MI_PROFILE_CAT_USER", "Paramètres utilisateur");
...
define("_MI_PROFILE_TRIBES", "Groupes");
define("_MI_PROFILE_PICTURES", "Images");
define("_MI_PROFILE_VIDEOS", "Vidéos");
define("_MI_PROFILE_TRIBEUSERS", "Adhésions");
